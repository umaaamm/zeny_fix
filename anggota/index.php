...
<body class="hold-transition skin-red sidebar-mini">
  ...
  <strong>PENGADUAN</strong>
      ...
      <span class="logo-mini"><b>PENGADUAN</b></span>
      ...
      <ul class="sidebar-menu" data-widget="tree">    
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="?m1=anggota&m2=anggota"><i class="fa fa-circle-o"></i> Data Diri</a></li>
            <li class="active"><a href="?m1=pengaduan&m2=pengaduananggota"><i class="fa fa-circle-o"></i> Pengaduan Anggota</a></li>
            <li class="active"><a href="?m1=tanggapan&m2=listtanggapan"><i class="fa fa-circle-o"></i> Tanggapan</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 | Zeny.</strong> All rights
    reserved.
  </footer>
