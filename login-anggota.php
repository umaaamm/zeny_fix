...
<head>
  ...
  <title>Web Pengaduan| Log in</title>
...
<div class="login-box">
  ...
  <?php
        if(isset($_POST['login']))
        {
            ...
            $querylogin=$koneksi->query("select nik,nama from tbl_anggota where nik='".$nik."' and password='".$password."'" );
            ...
            if ($jumlah > 0)
            {
                ...
                echo "<meta http-equiv='refresh' content=2;url='./anggota'/>";
            }
            else
            {
